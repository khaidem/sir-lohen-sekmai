...
class AppRouter extends _i4.RootStackRouter {
  ...
  final Map<String, _i4.PageFactory> pagesMap = {
    ...
    CustomerDetailsSearchRoute.name: (routeData) {
      final args = routeData.argsAs<CustomerDetailsSearchRouteArgs>();
      return _i4.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i10.CustomerDetailsSearchPage(
              key: args.key, customerModel: args.customerModel));
    },
              ...
              children: [
                _i4.RouteConfig(HomeTabRouter.name,
                    ...
                    children: [
                      ...
                      _i4.RouteConfig(CustomerDetailsSearchRoute.name,
...
/// generated route for [_i10.CustomerDetailsSearchPage]
class CustomerDetailsSearchRoute
  ...
  static const String name = 'CustomerDetailsSearchRoute';
}
